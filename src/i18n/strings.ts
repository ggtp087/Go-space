...
export const en = {
  ...
  dashboard: {
    ...
    pageTitle: 'Bangkok green & open space accessibility',
    pageSubtitle: 'SDG Indicator 11.7.1 · Bangkok Metropolitan Administration, Department of City Planning and Urban Development · Sample data for demonstration',
    areaSelectAllLabel: 'All districts',
    byDistrictCardTitle: 'Accessibility by district',
    bracketAccessibilitySuffix: 'accessibility',
    bracketCountSuffix: 'districts',
    rankingCardTitle: 'Highest & lowest accessibility districts',
    tableCardTitle: 'Districts',
    tableFooter: 'Showing {shown} of {total} districts',
    columns: {
      district: 'District',
